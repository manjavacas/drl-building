...
data <- rbind(RBC_cont_cool, A2C_cont_cool, PPO_cont_cool, RAND_cont_cool, DDPG_cont_cool) %>% 
  select(`Episodio`=`episode_num`,
         `recompensa_acumulada`=`cumulative_reward`,
         `consumo_acumulado`=`cumulative_power_consumption`,
         `violacion_de_confort`=`comfort_violation (%)`,
...
data <- rbind(RBC_cont_mixed, A2C_cont_mixed, PPO_cont_mixed, RAND_cont_mixed, DDPG_cont_mixed) %>% 
  select(`Episodio`=`episode_num`,
         `recompensa_acumulada`=`cumulative_reward`,
         `consumo_acumulado`=`cumulative_power_consumption`,
         `violacion_de_confort`=`comfort_violation (%)`,
...
data <- rbind(RBC_cont_hot, A2C_cont_hot, PPO_cont_hot, RAND_cont_hot, DDPG_cont_hot) %>% 
  select(`Episodio`=`episode_num`,
         `recompensa_acumulada`=`cumulative_reward`,
         `consumo_acumulado`=`cumulative_power_consumption`,
         `violacion_de_confort`=`comfort_violation (%)`,
